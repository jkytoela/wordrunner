	...
	return (
		<>
			...
			<div className="flex mt-4">
				<button
					type="button"
					className="py-2 px-4 bg-gray-600 hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-800 text-white w-full text-center text-base font-semibold shadow-md rounded-md mr-1"
					onClick={() => send('CLEAR')}
				>
					Clear
				</button>
				<button
					type="button"
					className="py-2 px-4 bg-green-700 hover:bg-green-800 text-white w-full text-center text-base font-semibold shadow-md rounded-md ml-1"
					onClick={() => send('BEGIN')}
				>
					Begin
				</button>
